  ...
  return (
    ...
    >
      ...
      >
        {/* Logo */}
        <div
          style={{ padding: "18px 20px", borderBottom: "1px solid #E2E8F0" }}
        >
          <Link
            to="/"
            style={{
        ...
        <div style={{ flex: 1, padding: "12px 10px" }}>
          ...
          <Link
            ...
            style={sidebarItemStyle("/employer/dashboard")}
            onMouseEnter={(e) => {
              if (!isActive("/employer/dashboard")) {
          ...
          <Link
            ...
            style={sidebarItemStyle("/employer/post-job")}
            onMouseEnter={(e) => {
              if (!isActive("/employer/post-job")) {
                e.currentTarget.style.background = "#F8FAFC";
                e.currentTarget.style.color = "#10B981";
              }
            }}
          ...
          <Link
            ...
            style={sidebarItemStyle("/employer/posted-jobs")}
            onMouseEnter={(e) => {
              if (!isActive("/employer/posted-jobs")) {
                e.currentTarget.style.background = "#F8FAFC";
                e.currentTarget.style.color = "#10B981";
              }
            }}
          ...
          <Link
            ...
            style={sidebarItemStyle("/employer/applicants")}
            onMouseEnter={(e) => {
              if (!isActive("/employer/applicants")) {
                e.currentTarget.style.background = "#F8FAFC";
                e.currentTarget.style.color = "#10B981";
              }
            }}
          ...
          <Link
            ...
            style={sidebarItemStyle("/employer/notifications")}
            onMouseEnter={(e) => {
              if (!isActive("/employer/notifications")) {
                e.currentTarget.style.background = "#F8FAFC";
                e.currentTarget.style.color = "#10B981";
              }
            }}
          ...
          <Link
            to="/employer/profile"
            style={sidebarItemStyle("/employer/profile")}
            onMouseEnter={(e) => {
              if (!isActive("/employer/profile")) {
                e.currentTarget.style.background = "#F8FAFC";
                e.currentTarget.style.color = "#10B981";
              }
            }}
          ...
          <Link
            ...
            style={sidebarItemStyle("/employer/settings")}
            onMouseEnter={(e) => {
              if (!isActive("/employer/settings")) {
                e.currentTarget.style.background = "#F8FAFC";
                e.currentTarget.style.color = "#10B981";
              }
            }}
            ...
            {showDropdown && (
              ...
              >
                ...
                <div style={{ padding: "8px 0" }}>
                  ...
                  >
                    <span style={{ fontSize: "16px" }}>⚙️</span> Cài đặt tài
                    khoản
                  </Link>
                </div>
