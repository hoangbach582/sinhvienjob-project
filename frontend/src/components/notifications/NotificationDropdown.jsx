      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            <h3 style={{ margin: 0, fontWeight: '700', color: '#111827', fontSize: '16px' }}>Thông báo</h3>
            {unreadCount > 0 && (
              <span style={{
        ...
        <div style={{ maxHeight: '420px', overflowY: 'auto' }}>
          {loading && notifications.length === 0 ? (
            <div style={{ padding: '48px', textAlign: 'center' }}>
              ...
              <p style={{ margin: '12px 0 0', color: '#9CA3AF', fontSize: '13px' }}>Đang tải thông báo...</p>
            </div>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '6px' }}>
                          ...
                          <span style={{
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" style={{ height: '11px', width: '11px' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div style={{ padding: '48px 24px', textAlign: 'center' }}>
              ...
              <p style={{ margin: 0, color: '#6B7280', fontWeight: '600', fontSize: '14px' }}>Chưa có thông báo nào</p>
              <p style={{ margin: '4px 0 0', color: '#9CA3AF', fontSize: '12px' }}>Thông báo mới sẽ xuất hiện tại đây</p>
            </div>
          )}
        </div>
