...
function StatusBadge({ status }) {
  ...
  const c = config[status] || { label: status, bg: '#F1F5F9', color: '#475569' };
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
          <thead>
            <tr style={{ background: '#F8FAFC' }}>
              <th style={{ padding: '10px 20px', textAlign: 'left', fontWeight: 600, color: '#475569', fontSize: '12px', whiteSpace: 'nowrap' }}>Vị trí</th>
              <th style={{ padding: '10px 12px', textAlign: 'left', fontWeight: 600, color: '#475569', fontSize: '12px' }}>Loại hình</th>
              <th style={{ padding: '10px 12px', textAlign: 'center', fontWeight: 600, color: '#475569', fontSize: '12px' }}>Hồ sơ</th>
              <th style={{ padding: '10px 12px', textAlign: 'left', fontWeight: 600, color: '#475569', fontSize: '12px' }}>Trạng thái</th>
              <th style={{ padding: '10px 20px', textAlign: 'right', fontWeight: 600, color: '#475569', fontSize: '12px' }}></th>
            </tr>
          </thead>
          <tbody>
            {loading ? (
  ...
  return (
    ...
    >
      ...
      <td style={{ padding: '12px 20px' }}>
        <span style={{ fontWeight: 600, color: '#0F172A', fontSize: '13px' }}>{job.title}</span>
        {job.deadline && (
