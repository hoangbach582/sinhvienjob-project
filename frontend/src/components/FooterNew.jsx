        ...
        >
          <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              >
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-br from-brand to-brand-light">
              ...
              <p className="mt-4 text-sm leading-relaxed text-white/60">
                ...
                Tìm kiếm cơ hội thực tập, part-time và full-time phù hợp nhất
                với bạn.
              </p>
