        ...
        <div className="relative grid grid-cols-1 items-center gap-8 lg:grid-cols-2">
          <div>
            ...
            <button
              ...
              className="mt-6 rounded-xl border-none bg-white px-6 py-3 text-sm font-semibold text-brand transition-colors hover:bg-white/90 cursor-pointer focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
            >
              Xem chi tiết
            </button>
          </div>
