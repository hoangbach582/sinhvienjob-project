...
function EmployerSettings() {
  ...
  const btnPrimary = { padding: '12px 32px', backgroundColor: '#10B981', color: '#fff', border: 'none', borderRadius: '8px', fontSize: '15px', fontWeight: 600, cursor: 'pointer', transition: 'background-color 0.2s' };
  ...
  return (
    <>
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(0,0,0,0.4)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, backdropFilter: 'blur(2px)' }}>
          <div style={{ backgroundColor: '#fff', padding: '32px', borderRadius: '16px', width: '90%', maxWidth: '340px', textAlign: 'center', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.1)' }}>
            ...
            <button onClick={() => setSuccessPopup('')} style={{ ...btnPrimary, width: '100%' }}
              ...
              onMouseLeave={(e) => e.target.style.backgroundColor = '#10B981'}>Đóng</button>
          </div>
        </div>
      )}
          ...
          <div style={{ backgroundColor: '#fff', padding: '32px', borderRadius: '16px', width: '90%', maxWidth: '420px', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.15)' }}>
            <div style={{ textAlign: 'center', marginBottom: '20px' }}>
              ...
              <p style={{ margin: 0, color: '#64748B', fontSize: '14px', lineHeight: 1.6 }}>
                Hành động này <strong style={{ color: '#DC2626' }}>không thể hoàn tác</strong>. Toàn bộ thông tin công ty, tin tuyển dụng và hồ sơ ứng viên đã nhận sẽ bị xóa vĩnh viễn.
              </p>
            </div>
      ...
      <div style={{ maxWidth: '800px' }}>
        ...
        <p style={{ color: '#64748B', fontSize: '15px', marginBottom: '28px' }}>Quản lý bảo mật và thông tin tài khoản nhà tuyển dụng</p>
        ...
        <div style={sectionCard}>
          ...
          {loadingInfo ? (
            ...
            <div>
              <div style={infoRow}>
                <span style={{ color: '#64748B', fontSize: '14px' }}>Tên công ty</span>
              ...
              <div style={infoRow}>
                ...
                <span style={{ padding: '4px 12px', borderRadius: '20px', fontSize: '13px', fontWeight: 600, backgroundColor: '#D1FAE5', color: '#065F46' }}>
                  Nhà tuyển dụng
                </span>
              </div>
          ...
          <form onSubmit={handleChangePassword} style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
              <button type="submit" disabled={passwordSaving} style={{ ...btnPrimary, cursor: passwordSaving ? 'not-allowed' : 'pointer', opacity: passwordSaving ? 0.7 : 1 }}
                onMouseEnter={(e) => { if (!passwordSaving) e.target.style.backgroundColor = '#059669'; }}
        ...
        <div style={{ ...sectionCard, borderColor: '#FECACA', backgroundColor: '#FFFBFB' }}>
          ...
          <p style={{ color: '#64748B', fontSize: '14px', lineHeight: 1.7, marginBottom: '20px' }}>
            Khi xóa tài khoản, tất cả dữ liệu bao gồm thông tin công ty, tin tuyển dụng đã đăng và hồ sơ ứng viên đã nhận sẽ bị xóa <strong>vĩnh viễn</strong> và không thể khôi phục.
          </p>
