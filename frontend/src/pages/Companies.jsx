...
function Companies() {
  ...
  const currentType = searchParams.get("type") || ""; // Lĩnh vực
  const currentSalary = searchParams.get("salary") || ""; // Trạng thái tuyển dụng
        ...
        >
          ...
          <div className="mb-8 w-full">
            <div
              ...
              style={{
                background: "rgba(130, 63, 235, 0.1)",
                border: "1px solid rgba(130, 63, 235, 0.2)",
              }}
            >
              <span className="text-brand-light text-xs font-semibold">
                ✨ Khám phá
              </span>
            </div>
            ...
            <p className="text-white/60 text-base md:text-lg max-w-2xl mx-auto">
              Tìm hiểu văn hóa công ty, môi trường làm việc và các cơ hội nghề
              nghiệp hấp dẫn dành riêng cho sinh viên thực tập và mới ra trường.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-6xl flex gap-6 items-start">
          ...
          <aside className="w-72 shrink-0 hidden lg:flex flex-col gap-6">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(130,63,235,0.1), rgba(99,102,241,0.1))",
                border: "1px solid rgba(130,63,235,0.2)",
              }}
            >
              <div
              ...
              >
                ...
                <p className="text-white/60 text-sm mb-4">
                  Nhận gợi ý công việc phù hợp với kỹ năng của bạn
                </p>
                <Link
                  to="/build-cv"
                  className="text-brand-light text-sm font-semibold hover:underline no-underline inline-flex items-center gap-1"
                >
          ...
          >
            ...
            >
              <h2 className="text-white font-semibold text-lg m-0 flex items-center gap-2">
                Tất cả công ty{" "}
                <span
                  className="text-white/40 text-sm font-normal px-2 py-0.5 rounded-full"
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  ...
                  >
                    ...
                    <option value="popular" style={{ background: "#1a1145" }}>
                      Phổ biến
                    </option>
                  </select>
            ...
            {loading ? (
              ...
              >
                ...
                <p className="text-white/50 text-base m-0">
                  Không tìm thấy công ty nào khớp với tiêu chí của bạn.
                </p>
                <button
                  onClick={clearFilter}
                            ...
                            <div className="min-w-0">
                              <div className="flex items-center gap-2">
                                <Link
                                  ...
                                  className="text-white font-bold text-lg hover:text-brand-light transition-colors no-underline truncate"
                                >
                                  {company.company_name}
                                </Link>
                                <svg
