          ...
          >
            <div style={{ textAlign: "center", marginBottom: "24px" }}>
              ...
              >
                ...
                . Toàn bộ hồ sơ, CV và lịch sử ứng tuyển sẽ bị xóa vĩnh viễn.
              </p>
            </div>
      ...
      >
        <div style={{ maxWidth: "800px", margin: "0 auto", padding: "0 20px" }}>
          ...
          >
            ...
            <div>
              ...
              <p style={{ color: "#94A3B8", fontSize: "14px", margin: 0 }}>
                Quản lý bảo mật và thông tin tài khoản của bạn
              </p>
            </div>
          </div>
                ...
                <div style={infoRow}>
                  ...
                  <span
                    style={{
                      ...
                      color:
                        accountInfo.role === "student" ? "#818cf8" : "#34d399",
                      border: `1px solid ${accountInfo.role === "student" ? "rgba(99, 102, 241, 0.3)" : "rgba(16, 185, 129, 0.3)"}`,
                    }}
                  >
          ...
          <div style={dangerCard}>
            ...
            >
              Khi xóa tài khoản, tất cả dữ liệu bao gồm hồ sơ cá nhân, CV đã tải
              lên và lịch sử ứng tuyển sẽ bị xóa{" "}
